...
export const ulSpace = "space-y-1";

/**
 * ファイル用のラベルにも使用中
 */
export const btn =
  "py-1.5 px-6 rounded cursor-pointer disabled:text-neutral-500 disabled:bg-neutral-200";
export const btnBlue = "text-white bg-blue-600 hover:bg-blue-700";
export const btnOutlineRed =
  "text-red-500 border border-red-100 border-red-500 hover:bg-red-50";
